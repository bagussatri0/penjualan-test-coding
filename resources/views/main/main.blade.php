...
<div class="wrapper">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <form action="/logout" method="post">
          @csrf
          <button type="submit" class="btn btn-secondary"><i class="nav-icon bi bi-box-arrow-right"></i>
          </button>
        </form>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link" style="text-align: center">
      ...
      <span class="brand-text font-weight-light">Qtasnim Penjualan</span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="/">E-KAS</a>.</strong>
    All rights reserved.
...
<script src="assets/AdminLTE/plugins/chart.js/Chart.min.js"></script>
<!-- FLOT CHARTS -->
<script src="assets/AdminLTE/plugins/flot/jquery.flot.js"></script>
<script src="assets/AdminLTE/plugins/flot/plugins/jquery.flot.resize.js"></script>
<script src="assets/AdminLTE/plugins/flot/plugins/jquery.flot.pie.js"></script>
@yield('js')
<script>
    $(function () {
      $("#example1").DataTable({
        ...
        buttons: [
        {
            ...
            extend: 'print',
            text: '<i class="bi bi-printer-fill"> Print</i>',
            titleAttr: 'Download Excel',
            exportOptions: {
                    columns: ':visible'
                },
...
{{-- <script >
  $(function () {
    ...
    for (var i in data) {
        ...
        jumlahMasuk.push(data[i].total_masuk);
    }
    
    var dataKeluar = @json($dataJumlahKeluar);
      var bulanKeluar = [];
      var jumlahKeluar = [];

      for (var i in dataKeluar) {
          bulanKeluar.push(dataKeluar[i].bulan);
          jumlahKeluar.push(dataKeluar[i].total_keluar);
      }
        ...
        datasets: [
            {
                ...
                data                : jumlahKeluar // Data akan diisi melalui permintaan AJAX
            },
            {
                label               : 'Kas Masuk',
                ...
                data                : jumlahMasuk // Data akan diisi melalui permintaan AJAX
            }
        ]
    };
